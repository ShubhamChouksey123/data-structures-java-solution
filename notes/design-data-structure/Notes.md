...
- [ ] [Design Twitter](https://leetcode.com/problems/design-twitter/) - Medium *(HashMap + heap merge)*
- [ ] [Design Browser History](https://leetcode.com/problems/design-browser-history/) - Medium *(array/stacks)*
