package dev.shubham.algorithms.priorityqueue;
...
public class CustomComparator {
    ...
    private class MinComparatorForDivision implements Comparator<Double[]> {
        ...
        public int compare(Double[] o1, Double[] o2) {
            System.out.println("o1[0]/o1[1] : " + o1[0] / o1[1] + " and o2[0]/o2[1] : " + o2[0] / o2[1]
                    + " and value return is : " + 10000 * (o1[0] / o1[1] - o2[0] / o2[1]));
    ...
    private class MaxComparatorForDivision implements Comparator<Double[]> {
        ...
        public int compare(Double[] o1, Double[] o2) {
            System.out.println("o1[0]/o1[1] : " + o1[0] / o1[1] + " and o2[0]/o2[1] : " + o2[0] / o2[1]
                    + " and value return is : " + 1000 * (o2[0] / o2[1] - o1[0] / o1[1]));
            return (int) (((o2[0] / o2[1]) - (o1[0] / o1[1])) * 100000);
        }
    }
    /** greater the value least is priority -1 > 0 > 1 > 2 */
}
