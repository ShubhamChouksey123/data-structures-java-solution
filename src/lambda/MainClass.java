...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        /**
         *
         * here we are only creating the implementation of the function alone
         * This is an lambda functions of type Greeting interface
         */
         ...
         * Here we are creating the implementation of Greeting interface
         */
